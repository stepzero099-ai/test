  ...
  return (
    <header className="sticky top-0 z-40 bg-slate-900 border-b border-slate-800 text-white shadow-xl">
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
        {/* Brand Logo & Tagline */}
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => onSelectFilter('all')}>
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-sky-600 via-blue-600 to-indigo-700 flex items-center justify-center shadow-lg shadow-sky-900/30 border border-sky-400/30">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white text-xs md:text-sm font-semibold px-3 py-2 rounded-xl shadow-md transition active:scale-95"
            title="الحصاد التنفيذي الشامل لأبرز أحداث اليوم"
          >
            <Sparkles className="w-4 h-4 text-amber-100" />
            <span className="hidden sm:inline">الحصاد اليومي</span>
          </button>
