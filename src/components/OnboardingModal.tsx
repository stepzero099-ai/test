          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {[
                {
                  id: 'both' as const,
                  title: 'الأخبار العاجلة والملخص اليومي (موصى به)',
                  desc: 'تنبيه فوري عند وقوع أحداث طارئة + إشعار بالحصاد الصباحي/المسائي',
                ...
                },
                {
                  ...
                  title: 'الملخص اليومي الذكي فقط',
                  desc: 'إشعار واحد يومياً في الصباح يتضمن قراءة تنفيذية في 3 دقائق',
