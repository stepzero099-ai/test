        ...
        <div className="p-6 sm:p-8 overflow-y-auto space-y-6 flex-1 text-sm text-slate-700 dark:text-slate-300">
          {activeTab === 'env' && (
            <>
              ...
              <div className="bg-slate-50 dark:bg-slate-800/50 p-5 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 font-bold text-slate-900 dark:text-white">
                    ...
                    <span>1. GNews.io API (مصدر عالمي فوري)</span>
                  </div>
                  <a
                    href="https://gnews.io"
                    target="_blank"
              ...
              <div className="bg-slate-50 dark:bg-slate-800/50 p-5 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 font-bold text-slate-900 dark:text-white">
                    ...
                    <span>2. NewsData.io API (أخبار عربية وعالمية موسعة)</span>
                  </div>
                  <a
                    href="https://newsdata.io"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-xs text-teal-600 dark:text-teal-400 inline-flex items-center gap-1 hover:underline"
                  >
                    <span>الحصول على مفتاح مجاني</span>
                    <ExternalLink className="w-3 h-3" />
                  </a>
                ...
                <div className="bg-slate-900 text-slate-200 p-3 rounded-xl font-mono text-xs flex items-center justify-between">
                  <span>NEWSDATA_API_KEY="YOUR_NEWSDATA_KEY"</span>
                  <button
                    onClick={() => copyToClipboard('NEWSDATA_API_KEY=""', 'newsdata')}
                    className="text-slate-400 hover:text-white"
                  >
                    {copiedKey === 'newsdata' ? <Check className="w-3.5 h-3.5 text-emerald-400" /> : <Copy className="w-3.5 h-3.5" />}
                  </button>
                </div>
              </div>
              ...
              <div className="bg-slate-50 dark:bg-slate-800/50 p-5 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 font-bold text-slate-900 dark:text-white">
                    ...
                    <span>3. NewsAPI.org (أخبار عالمية وعناوين رئيسية)</span>
                  </div>
                  <a
                    href="https://newsapi.org"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-xs text-purple-600 dark:text-purple-400 inline-flex items-center gap-1 hover:underline"
                  >
                    <span>الحصول على مفتاح مجاني</span>
                    <ExternalLink className="w-3 h-3" />
                  </a>
              ...
              {/* 5. FreeNews / Currents API */}
              <div className="bg-slate-50 dark:bg-slate-800/50 p-5 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 font-bold text-slate-900 dark:text-white">
                    <Globe className="w-4 h-4 text-amber-500" />
                    <span>4. FreeNews / Currents API (بث إخباري متعدد اللغات)</span>
                  </div>
                  <a
                ...
                <div className="bg-slate-900 text-slate-200 p-3 rounded-xl font-mono text-xs flex items-center justify-between">
                  <span>FREENEWS_API_KEY="YOUR_CURRENTS_KEY"</span>
                  <button
                    onClick={() => copyToClipboard('FREENEWS_API_KEY=""', 'freenews')}
                    className="text-slate-400 hover:text-white"
                  >
                    {copiedKey === 'freenews' ? <Check className="w-3.5 h-3.5 text-emerald-400" /> : <Copy className="w-3.5 h-3.5" />}
                  </button>
                </div>
              </div>
